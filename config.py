...
# Bot Information
BOT_TOKEN = environ.get("BOT_TOKEN", "7498735093:AAEaO6EvPML6g0M-MIrrPvorv6CvRWWFfas")
BOT_USERNAME = environ.get("BOT_USERNAME", "Sung_Jin_Woo_PB_bot") # your bot username without @
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002176527273')).split()]
...
class Var(object):
    ...
    if HAS_SSL:
        URL = "https://sung-jin-woo-pb-bot.onrender.com/"
    else:
        URL = "https://sung-jin-woo-pb-bot.onrender.com/"
